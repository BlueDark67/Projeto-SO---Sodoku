// servidor/src/logs.c - Sistema de logging do servidor
...
const char *obterDescricaoEvento(CodigoEvento evento)
{
    switch (evento)
    {
    case EVT_SERVIDOR_INICIADO:
        return "Servidor Iniciado";
    case EVT_JOGOS_CARREGADOS:
        return "Jogos Carregados";
    case EVT_CLIENTE_CONECTADO:
        return "Cliente Conectado";
    case EVT_CLIENTE_DESCONECTADO:
        return "Cliente Desconectado";
    case EVT_JOGO_PEDIDO:
        return "Jogo Pedido";
    case EVT_JOGO_ENVIADO:
        return "Jogo Enviado";
    case EVT_SOLUCAO_RECEBIDA:
        return "Solucao Recebida";
    case EVT_SOLUCAO_VERIFICADA:
        return "Solucao Verificada";
    case EVT_SOLUCAO_CORRETA:
        return "Solucao Correta";
    case EVT_SOLUCAO_ERRADA:
        return "Solucao Errada";
    case EVT_AGUARDANDO_PAR:
        return "Aguardando Par";
    case EVT_PAR_FORMADO:
        return "Par Formado";
    case EVT_CLIENTE_DESBLOQUEADO:
        return "Cliente Desbloqueado";
    case EVT_TIMEOUT_CONFIGURADO:
        return "Timeout Configurado";
    case EVT_SERVIDOR_ENCERRADO:
        return "Servidor Encerrado";
    case EVT_VALIDACAO_BLOCO:
        return "Validacao Bloco";
    case EVT_VALIDACAO_BLOCO_OK:
        return "Bloco OK";
    case EVT_VALIDACAO_BLOCO_NOK:
        return "Bloco NOK";
    case EVT_JOGO_PERDIDO:
        return "Jogo Perdido";
    case EVT_ERRO_GERAL:
        return "Erro Geral";
    default:
